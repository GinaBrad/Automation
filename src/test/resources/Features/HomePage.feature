Feature: HomePage
 ...
 Scenario: Add to cart Home and Decor
   Given I open the homepage
...
Scenario: Add to cart Cosplay Outfit
  Given I open the homepage
...
Scenario: Add to cart Little Ones
  Given I open the homepage
...
Scenario: And to cart VIP
  Given I open the homepage
  And I click on the VIP link
  And I click on the Iphone 13 Pro
...
Scenario: Add to cart Test Category
  Given I open the homepage
...
Scenario: LogIn with walid username
  Given I open the homepage
  And I click on the Account button
